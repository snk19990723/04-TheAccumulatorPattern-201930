...
def run_test_sum_more_cosines():
    ...
    # Test 3:
    expected = 0.91665  # This is APPROXIMATELY the correct answer.
    ...
    # Test 4:
    expected = -1.5416  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_from():
    ...
    expected = 9
    answer = count_sines_from(2, 14)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 79
    answer = count_sines_from(20, 140)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 29
    answer = count_sines_from(72, 114)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 3:
    expected = 182
    answer = count_sines_vs_cosines(181)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 82
